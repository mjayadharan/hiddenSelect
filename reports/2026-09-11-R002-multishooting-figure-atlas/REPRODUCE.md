...
$J analysis/11_lv_landscape.jl      # LV landscape at every κ (~2 min)
$PY figures/make_animations.py      # seven MP4s (uses the FFMPEG_jll artifact binary, see script header)
