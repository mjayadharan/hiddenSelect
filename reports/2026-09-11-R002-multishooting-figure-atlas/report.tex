...
\end{longtable}
\normalsize
\noindent Animations (MP4, H.264; frames regenerable by \texttt{figures/make\_animations.py}; the GIF \texttt{anim\_sweep.gif} is the same content as the first one):
